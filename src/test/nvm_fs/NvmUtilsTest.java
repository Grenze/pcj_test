...
public class NvmUtilsTest {
    ...
    public static void testAll() throws IOException {
        ...
        NvmFileUtils.nvmMkDirs(new File("1/3"), false, true);

        NvmFileUtils.nvmMkDirs(new File("2/2"), false, true);
        NvmFileUtils.nvmMkDirs(new File("2/1/2"), false, true);

        NvmFileUtils.copyDirectory(new File(("1")), new File("2"));
